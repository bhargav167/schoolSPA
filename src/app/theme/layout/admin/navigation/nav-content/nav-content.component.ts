...
import { StudentNavigationItem } from '../Studentnavigation';
...
export class NavContentComponent implements OnInit, AfterViewInit {
  ...
  constructor(public nav: NavigationItem, public stuNav:StudentNavigationItem, private zone: NgZone, private location: Location) {
